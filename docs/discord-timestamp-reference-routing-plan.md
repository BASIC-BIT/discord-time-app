...
Status: V22 release candidate implemented and fully evaluated locally; its hash-verified model package is published, and production desktop v0.1.5 remains behind PR and installed-MSI release gates. Production remains unchanged until those gates complete.
