...
- Decision: Qwen3.5 0.8B bf16/chat noisy-input-2586 is promoted as the canonical local adapter. Keep v4h as rollback, and prioritize shortening verbose clarification outputs because the six-way clarification remains the latency outlier.
