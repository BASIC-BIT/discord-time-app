...
- Adapter directory: `ml/temporal-ir/outputs/qwen-temporal-ir-qwen35-08b-bf16-chat-clock-choice-v19-prefix-ambiguity-balanced-lora`
...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\package-local-slm-runtime.ps1 \
  -DownloadBaseUrl "https://github.com/BASIC-BIT/discord-time-app/releases/download/local-slm-runtime-qwen35-clock-choice-v19"
```
...
- Release tag: `local-slm-runtime-qwen35-clock-choice-v19`
- Package URL: `https://github.com/BASIC-BIT/discord-time-app/releases/download/local-slm-runtime-qwen35-clock-choice-v19/qwen-temporal-ir-qwen35-08b-bf16-chat-clock-choice-v19-prefix-ambiguity-balanced-lora.zip`
- Package size: `145900563` bytes
- SHA-256: `3b36fbaedda523ad139db829785c1d8cf1b6e628047f8bd6b7d87dcb1a2f13e7`
- Local ZIP: `artifacts/local-slm-runtime/qwen-temporal-ir-qwen35-08b-bf16-chat-clock-choice-v19-prefix-ambiguity-balanced-lora.zip`
- Local manifest: `artifacts/local-slm-runtime/local-slm-runtime-manifest.json`

The V19 package and sanitized manifest were published to the dedicated prerelease and downloaded again on 2026-08-10. Both remote assets matched the local byte counts and SHA-256 hashes exactly. The app constants point at that verified release-asset URL. If the adapter is repackaged, update both the release asset and `LOCAL_SLM_ADAPTER_PACKAGE_SHA256` before release.
...
- `Start Local SLM` reaches `ready` and `/v1/models` exposes `qwen-temporal-ir-qwen35-08b-bf16-chat-clock-choice-v19-prefix-ambiguity-balanced`.
...
2026-08-10 V19 packaging and installed routing-smoke gate:
