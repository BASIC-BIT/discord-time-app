...
param(
    ...
    [string]$AdapterPath = "ml/temporal-ir/outputs/qwen-temporal-ir-qwen35-08b-bf16-chat-month-clock-lora",
    [string]$ModelName = "qwen-temporal-ir-qwen35-bf16-chat-month-clock",
    [int]$Port = 8765,
