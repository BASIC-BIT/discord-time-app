...
param(
    ...
    [string]$AdapterPath = "ml/temporal-ir/outputs/qwen-temporal-ir-qwen35-08b-bf16-chat-range-format-infix-v22-lora",
    [string]$ModelName = "qwen-temporal-ir-qwen35-08b-bf16-chat-range-format-infix-v22",
    [int]$Port = 8770,
